...
/**
 * Top header for verify-step screens that need a "← BACK" affordance plus
 * the Language & Accessibility button. Replaces the marketing SiteNav on
 * pages where the questionnaire-style minimal chrome is appropriate.
 *
 * SiteNav opts itself out for these routes; this component takes its place.
 */
...
export default function PortalBackHeader({ backHref }: PortalBackHeaderProps) {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-sm bg-white/90 border-b border-[#e3e3e3]">
