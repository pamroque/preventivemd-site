...
export default function BackHeader({ backHref, progress }: BackHeaderProps) {
  ...
  return (
    <header
      className={`back-header-enter fixed top-0 left-0 right-0 z-50 flex flex-col backdrop-blur-sm bg-white/90 ${
    ...
    >
      ...
      <div className="flex h-12 md:h-14 items-center justify-between px-4 py-2">
        ...
        <div className="flex items-center gap-3 md:gap-6">
          ...
          <Link
            href={backHref}
            className="flex items-center gap-2 px-2 py-1 rounded-md text-brand-navy hover:bg-gray-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3b82f6]"
            aria-label="Go back"
          >
            <ChevronLeftIcon />
      ...
      {hasProgress && (
        ...
        >
          ...
          <div
            className="absolute left-0 top-0 h-full bg-brand-blue transition-all duration-500"
