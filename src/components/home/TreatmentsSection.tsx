    ...
    <article className="flex flex-col items-center gap-6 rounded-[36px] border border-[#e4e4e7] bg-white/80 p-8 backdrop-blur-[2px]">
      <div className="flex w-full flex-col gap-3">
        <div className="flex w-full items-center gap-3">
          <h3 className="font-serif italic text-[32px] leading-[1.1] text-[#09090b]">
            {treatment.name}
            {treatment.trademark && (
              <span className="text-[20.64px] align-baseline ml-0.5">
                {treatment.trademark}
              </span>
            )}
          </h3>
      ...
      <div className="flex w-full items-start gap-3">
        <Link
          ...
          className="flex flex-1 items-center justify-center gap-3 rounded-lg border border-[#e4e4e7] bg-white px-4 py-2 text-[12px] font-medium uppercase tracking-[0.96px] leading-6 text-[#09090b] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] transition-colors hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3b82f6]"
        >
          Learn more
        </Link>
        <Link
          href={treatment.href}
          className="relative flex flex-1 items-center justify-center gap-3 rounded-lg border border-[#3A5190] bg-[#3A5190] px-4 py-2 text-[16px] font-medium leading-6 text-white shadow-[inset_0px_2px_0px_0px_rgba(255,255,255,0.15)] transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#3b82f6] focus-visible:ring-offset-2"
        >
          Get started
        </Link>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative flex w-full flex-col gap-3">
        ...
        >
          <span className="text-[36px] md:text-[54px]">Physician-curated </span>
          <span className="font-serif italic text-[42px] md:text-[64px]">protocols</span>
        </h2>
      </div>
